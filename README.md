# Introduction
Wein2DAndroid is a collection of java classes to speed up the process of making a game in java for android. Its and code methods and classes are based on [Wein2D](https://www.github.com/devtaube/wein2d).
